...
<div class="container my-5">
	<h1>${fn:toUpperCase(fn:substring(category, 0, 1))}${fn:toLowerCase(fn:substring(category, 1,fn:length(category)))}</h1>
	<nav aria-label="breadcrumb">
	  <ol class="breadcrumb">
	    ...
	    <li class="breadcrumb-item active">
	    	<a href="${context}/CustomerProductByCategory?category=${category}" class="grey nounderline">
	    		<b>${fn:toUpperCase(fn:substring(category, 0, 1))}${fn:toLowerCase(fn:substring(category, 1,fn:length(category)))}</b>
	    	</a>
	    </li>
	  </ol>
	</nav>
