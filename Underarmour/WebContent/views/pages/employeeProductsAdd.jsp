...
<div class="container my-5 sidebarContainer">
	...
	<hr>
	<form action="./EmployeeProductsAdd" method="post" accept-charset="utf-8">
	  <div class="mb-3">
	  ...
	  <div class="row">
		  <div class="col-md-6">
		  		<div class="mb-4">
					  ...
					  <input type="number" class="form-control" step="0.1" name="price" min="0" id="inputPrice" required/>
					</div>
				</div>
		  	</div>
		  	<div class="col-md-6">
		  		<div class="mb-3">
			  		...
			  		<input type="number" class="form-control" name="stock" min="0" id="inputStock" required/>
				</div>
		  	</div>
	  </div>
	  <div class="mb-3">
	    <label for="inputDesc" class="form-label">Description</label>
		<textarea name="description" id="inputDesc" class="form-control" required></textarea>
	  </div>
	  <div class="mb-3">
  		<label for="inputColor" class="form-label">Color</label>
  		<input type="color" class="form-control form-control-color" name="color" id="inputColor" required/>
	  </div>
	  <div class="row">
	  	<div class="col-md-1">
